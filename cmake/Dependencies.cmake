...
# ---[ Avoid a problem linking libcaffe2.so
...
# ---[ BLAS
if(CMAKE_SYSTEM_PROCESSOR MATCHES "aurora")
  set(BLAS "NLC" CACHE STRING "Selected BLAS library")
else()
...
elseif(BLAS STREQUAL "NLC")
  include_directories(SYSTEM ${VE_CBLAS_INCLUDE_DIR})
  list(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS ${VE_NLC_CBLAS_LIB_PATHS})
  set(NLC_FOUND 1)
  message(STATUS "BLAS equals NLC")
  message(STATUS "PUB DEP LIBS ${Caffe2_PUBLIC_DEPENDENCY_LIBS}")
else()
...
if (NOT BUILD_ATEN_MOBILE)
  ...
  set(AT_MKL_MT 0)
  set(USE_BLAS 1)
  if(NOT (ATLAS_FOUND OR OPENBLAS_FOUND OR MKL_FOUND OR VECLIB_FOUND OR NLC_FOUND))
